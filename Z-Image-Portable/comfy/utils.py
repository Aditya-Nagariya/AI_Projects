...
def load_torch_file(ckpt, safe_load=False, device=None, return_metadata=False):
    ...
    if ckpt.lower().endswith(".safetensors") or ckpt.lower().endswith(".sft"):
        try:
            logging.info(f"[DEBUG] load_torch_file: ckpt={ckpt}, dynamic_vram={enables_dynamic_vram()}, device={device}, safetensors_version={safetensors.__version__}, file_size={os.path.getsize(ckpt)}")
